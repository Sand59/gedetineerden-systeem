...
<script>
    document.getElementById('aantal').innerHTML = "<?php echo 'Selecteer hier de gedetineerde waarbij je de bezoeker wilt registreren of bekijken'; ?>";
</script>
...
<a class="button" href="/pages/bezoeker/geregistreerd.php">Bekijk hier alle geregistreerde bezoekers<img src="/images/icons/arrow-right-white.png"></a>
...
if ($aantal > 0) {
    foreach ($gedetineerde as $row) {
        $table .= "<tr>
                      ...
                      <td><div class='image-wrapper-link'><a href='bezoeker/view.php?id={$row['id']}'>Bekijken</a><img src='/images/icons/open.png'></div></td>
                  </tr>";
    }
}
