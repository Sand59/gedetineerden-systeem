...
class Authenticator
{
   ...
   public function __construct($dbconn) {
    ...
    public function addAuthSecret($secret, $id) {
      $query = "UPDATE gebruiker SET auth_secret = :auth_secret WHERE gebruiker.id = :id";

      $stmt = $this->conn->prepare($query);

      // bind variables
      $stmt->bindParam(':auth_secret', $secret, PDO::PARAM_STR);
    ...
    // de functies hieronder komen hier vandaan
